  ...
  private static ContentHandler getEADEmptyHandler(
      ...
      ContentHandler defaultContentHandler = new TextContentHandler(handler, true);
       return new TeeContentHandler(
                ...
                getEADHandler(metadata, CendariProperties.DESCRIPTION, "arrangement"),
                getEADHandler(metadata, CendariProperties.DESCRIPTION, "unittitle"),
                getEADHandler(metadata, CendariProperties.RIGHTS, "licence"),
                getEADHandler(metadata, CendariProperties.PLACE, "geogname" ),
                getEADHandler(metadata, CendariProperties.PERSON, "persname"),
                getEADHandler(metadata, CendariProperties.KEYWORDS, "subject"),
                ...
                getEADHandler(metadata, CendariProperties.NERD, "name"),
                getEADHandler(metadata, CendariProperties.NERD, "geogname"),
                getEADHandler(metadata, CendariProperties.NERD, "subject"),
                getEADHandler(metadata, CendariProperties.NERD, "persname"),
                ...
                getEADEmptyHandler(metadata, CendariProperties.DESCRIPTION,"arrangement"),
                ...
                getEADEmptyHandler(metadata, CendariProperties.PLACE, "geogname"),
                getEADEmptyHandler(metadata, CendariProperties.KEYWORDS, "subject"),
                getEADEmptyHandler(metadata, CendariProperties.PERSON, "persname"),
                ...
                getEADEmptyHandler(metadata, CendariProperties.NERD, "name"),
                getEADEmptyHandler(metadata, CendariProperties.NERD, "geogname"),
                getEADEmptyHandler(metadata, CendariProperties.NERD, "subject"),
                getEADEmptyHandler(metadata, CendariProperties.NERD, "persname"),
